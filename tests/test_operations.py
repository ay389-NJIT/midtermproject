...
class TestModulus(BaseOperationTest):
    ...
    invalid_test_cases = {
        "modulus_by_zero": {
            ...
            "b": "0",
            "error": ValidationError,
            "message": "Cannot calculate modulus with zero divisor"
        },
    }
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "decimal_values": {"a": "7.5", "b": "50", "expected": "15"},
        "small_percentage": {"a": "1", "b": "1000", "expected": "0.1"},
        "large_base": {"a": "500", "b": "200", "expected": "250"},
    }
    invalid_test_cases = {
        "zero_base": {
            "a": "25",
...
class TestAbsoluteDifference(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "large_numbers": {"a": "1000", "b": "250", "expected": "750"},
    }
